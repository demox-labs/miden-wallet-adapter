...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'eventemitter3'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class BaseWalletAdapter extends Object(function webpackMissingModule() { var e = new Error("Cannot find module 'eventemitter3'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) {
    get connected() {
...
/* harmony export */ });
/* harmony import */ var _adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./adapter */ "../../core/base/dist/adapter.js");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors */ "../../core/base/dist/errors.js");
/* harmony import */ var _signer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./signer */ "../../core/base/dist/signer.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./types */ "../../core/base/dist/types.js");
/* harmony import */ var _transaction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transaction */ "../../core/base/dist/transaction.js");
/* harmony import */ var _deployment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deployment */ "../../core/base/dist/deployment.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TridentWalletAdapter: () => (/* binding */ TridentWalletAdapter),
/* harmony export */   TridentWalletName: () => (/* binding */ TridentWalletName)
/* harmony export */ });
/* harmony import */ var _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @demox-labs/miden-wallet-adapter-base */ "../../core/base/dist/index.js");
...
class TridentWalletAdapter extends _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.BaseMessageSignerWalletAdapter {
    ...
    _readyState = typeof window === 'undefined' || typeof document === 'undefined'
        ? _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletReadyState.Unsupported
        : _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletReadyState.NotDetected;
    constructor({ appName = 'sample' } = {}) {
        super();
        this._connecting = false;
        this._wallet = null;
        this._publicKey = null;
        this._decryptPermission = _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.DecryptPermission.NoDecrypt;
        console.log('TridentWalletAdapter', appName);
        if (this._readyState !== _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletReadyState.Unsupported) {
            (0,_demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.scopePollingDetectionStrategy)(() => {
                if (window?.tridentWallet || window?.trident) {
                    this._readyState = _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletReadyState.Installed;
    ...
    async requestTransaction(transaction) {
        try {
            ...
            try {
                ...
                throw new _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletTransactionError(error?.message, error);
            }
        }
        catch (error) {
    ...
    async connect(decryptPermission, network, programs) {
        try {
            if (this.connected || this.connecting)
                return;
            if (this._readyState !== _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletReadyState.Installed)
            ...
            try {
                ...
                throw new _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletConnectionError(error?.message, error);
            }
            this._wallet = wallet;
    ...
    async disconnect() {
        ...
        if (wallet) {
            ...
            try {
                ...
                this.emit('error', new _demox_labs_miden_wallet_adapter_base__WEBPACK_IMPORTED_MODULE_0__.WalletDisconnectionError(error?.message, error));
            }
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TridentWalletAdapter: () => (/* reexport safe */ _adapter__WEBPACK_IMPORTED_MODULE_0__.TridentWalletAdapter),
/* harmony export */   TridentWalletName: () => (/* reexport safe */ _adapter__WEBPACK_IMPORTED_MODULE_0__.TridentWalletName)
/* harmony export */ });
...
var __webpack_exports__TridentWalletAdapter = __webpack_exports__.TridentWalletAdapter;
var __webpack_exports__TridentWalletName = __webpack_exports__.TridentWalletName;
export { __webpack_exports__TridentWalletAdapter as TridentWalletAdapter, __webpack_exports__TridentWalletName as TridentWalletName };
